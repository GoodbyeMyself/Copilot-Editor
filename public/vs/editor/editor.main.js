define("vs/editor/editor.main", ["exports", "require", "vs/nls.messages-loader!", "../basic-languages/monaco.contribution", "../language/css/monaco.contribution", "../language/html/monaco.contribution", "../language/json/monaco.contribution", "../language/typescript/monaco.contribution", "../editor.api-4q1eAE-V"], (function(exports, require, nls_messagesLoader_, basicLanguages_monaco_contribution, language_css_monaco_contribution, language_html_monaco_contribution, language_json_monaco_contribution, language_typescript_monaco_contribution, editor_api) {
  ...
  const __worker_url_0__ = "" + new URL(require.toUrl("../assets/json.worker-PWqfl9As.js"), document.baseURI).href;
  const __worker_url_1__ = "" + new URL(require.toUrl("../assets/css.worker-FffBZ9Cm.js"), document.baseURI).href;
  const __worker_url_2__ = "" + new URL(require.toUrl("../assets/html.worker-BLoXGat9.js"), document.baseURI).href;
  const __worker_url_3__ = "" + new URL(require.toUrl("../assets/ts.worker-D7RoM0tf.js"), document.baseURI).href;
  const __worker_url_4__ = "" + new URL(require.toUrl("../assets/editor.worker-2r0DwJtK.js"), document.baseURI).href;
