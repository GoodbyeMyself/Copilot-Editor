define("vs/basic-languages/monaco.contribution", ["require", "../editor.api-4q1eAE-V"], (function(require, editor_api) {
  "use strict";
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagAutoInterpolationDollar);
      }
    }
  });
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagAngleInterpolationDollar);
      }
    }
  });
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagBracketInterpolationDollar);
      }
    }
  });
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagAngleInterpolationBracket);
      }
    }
  });
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagBracketInterpolationBracket);
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../freemarker2-wPTye-tj"], resolve, reject)).then((m) => m.TagAutoInterpolationBracket);
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../handlebars-DgMsZDED"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../html-ChJKOjhO"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../javascript-CKwGrAqF"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../liquid-DfvnJvJf"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../mdx-Lzf7wSdv"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../python-DFWGupEu"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../razor-DEt1RkRs"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../typescript-47zxDIot"], resolve, reject));
      }
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../xml-DRId97DP"], resolve, reject));
      }
    }
  });
  registerLanguage({
    ...
    loader: () => {
      {
        return new Promise((resolve, reject) => require(["../yaml-Bw1BG4AE"], resolve, reject));
      }
    }
  });
}));
